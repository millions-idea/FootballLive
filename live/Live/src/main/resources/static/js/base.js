...
if (os.isAndroid || os.isPhone) {
    //alert("手机" );
    var url = $(".o-download-app-btn").attr("href");
...
$(function(){
    ...
    layui.use(["form", "layer"],function(){
        ...
        setHotSchedule(function () {
            var defaultVideo = $(".recommend-game-list li").eq(0);
            var defaultVideoUrl = $(defaultVideo).data("url");
        ...
        setInterval(function(){
            setHotSchedule(function(){
                ...
                var defaultVideoUrl = $(defaultVideo).data("url");
                if(defaultVideoUrl != null && defaultVideoUrl != undefined && defaultVideoUrl != "#"){
                    if($("#isOver").val() == null || $("#isOver").val() == "1"){
...
function setHotSchedule(callback){
    try{
        $.get("./getHotSchedule", function(html){
            ...
            $(".recommend-game-list li").unbind("click").bind("click",function () {
                ...
                if(sourceUrl != null && sourceUrl != undefined && sourceUrl != "#"){
                    ...
                    player.changeControlBarShow(false);//隐藏控制栏
                    $(".video-full-player .tips").hide();
                    $(".recommend-game-list li").removeClass("select active");
