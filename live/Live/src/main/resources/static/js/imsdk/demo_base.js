...
function showMsg(msg) {
    ...
    switch (subType) {
        ...
        case webim.GROUP_MSG_SUB_TYPE.COMMON: //群普通消息
            if(!isSelfSend){
                message = convertMsgtoHtml(msg);
                setUserMessageHtml(fromAccountNick, message);
            }
            break;
        case webim.GROUP_MSG_SUB_TYPE.REDPACKET: //群红包消息
            message =  convertMsgtoHtml(msg);
            setSystemMessageHtml(message);
            break;
...
function addMessage(message) {
    ...
    html += '        <span class="phone">' + $("#nickname").val() + '</span>';
...
function convertGroupTipMsgToHtml(content) {
    ...
    switch (opType) {
        case webim.GROUP_TIP_TYPE.JOIN: //加入群
            ...
            text = userIdList[0].NickName + " 进入房间";
            //房间成员数加1
        ...
        case webim.GROUP_TIP_TYPE.QUIT: //退出群
            ...
            //text += quitName + "离开房间";
            text = userIdList[0].NickName + " 离开房间";
            //房间成员数减1
...
function setSystemMessageHtml(message) {
    var html = "";
    html += '<li class="systemMsg">';
    html += '    <p class="text-cont">';
    html += '        <span class="phone">' + "系统" + '</span>';
    html += '        <span class="content">' + htmlEncode(message) + '</span>';
    html += '    </p>';
    html += '</li>';
    $(".chat-list").append(html);
...
function setUserMessageHtml(nick, message) {
    if(nick == "admin1") nick = "游客";
    var html = "";
    html += '<li>';
    html += '    <p class="text-cont">';
    html += '        <span class="phone">' + nick  + '</span>';
    html += '        <span class="content">' + htmlEncode(message) + '</span>';
    html += '    </p>';
    html += '</li>';
    $(".chat-list").append(html);
