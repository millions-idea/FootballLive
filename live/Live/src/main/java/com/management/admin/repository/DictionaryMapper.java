...
@Mapper
public interface DictionaryMapper extends MyMapper<DictionaryEntity> {
     ...
     * @return
     */
    List<DictionaryEntity> selectByKey(@Param("likeKey") String likeKey);
     ...
     * @return
     */
    DictionaryEntity selectOneKey(@Param("key") String key);
    ...
    List<DictionaryEntity> selectInKey(@Param("joinKeys") String join);
