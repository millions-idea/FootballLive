...
var route = "/management/advertising";
var service;
var tableIndex;
(function () {
    ...
    // 加载数据表
    initDataTable(route + "/getAdvertisingLimit", function (form, table, layer, vipTable, tableIns) {
...
function initService(r) {
    return {
        ...
        delete: function (param, callback) {
            $.get(r + "/deleteAdvertising", param, function (data) {
                callback(data);
            });
        },
...
function getTableColumns() {
    return [[
        ...
        , {field: 'adId', title: 'ID', width: 80, sort: true}
        , {field: 'liveTitle', title: '直播间', width: 150}
        , {field: 'type', title: '广告类型', width: 150, sort: true, templet: function (d) {
                return d.type == null ? '' : utils.type.typeInfo(d.type);
            }}
        , {field: 'sourceUrl', title: '源链接', width: 150}
        , {field: 'targetUrl', title: '广告链接', width: 150 }
