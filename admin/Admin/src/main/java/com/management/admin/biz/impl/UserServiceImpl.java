...
public class UserServiceImpl implements IUserService {
    ...
    public List<User> getBackLimit(Integer page, String limit, String condition,Integer state, String beginTime, String endTime) {
        ...
        page = ConditionUtil.extractPageIndex(page, limit);
        String where = extractLimitWhere(condition,state, beginTime, endTime);
        List<User> list = userMapper.selectBackLimit(page, limit, state, beginTime, endTime, where);
        return list;
    }
    ...
    public Integer getBackCount() {
        return userMapper.queryBackCount();
    }
     ...
     */
    @Override
    public Integer getBackLimitCount(String condition,Integer state, String beginTime, String endTime) {
        String where = extractLimitWhere(condition, state, beginTime, endTime);
        return userMapper.selectLimitCount(state, beginTime, endTime, where);
    }
